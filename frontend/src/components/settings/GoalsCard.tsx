  ...
  return (
    <div className="glass settings-card" style={{ padding: 24 }}>
      ...
      <div className="settings-goals-summary">
        ...
        <SummaryPill label="Sodium max" value={formatGoalNumber(goalSettings?.daily_sodium_mg_max, 0, 'mg')} />
      </div>
      ...
      <div className="settings-goals-grid">
        {(
          [
            ...
            { field: 'daily_sodium_mg_max', label: 'Sodium limit', unit: 'mg', mode: 'numeric', placeholder: '2300' },
