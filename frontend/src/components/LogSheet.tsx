  ...
  return (
    <div className="log-sheet-overlay" style={isPageMode ? {
      ...
      <div className="glass log-sheet-panel" style={{
        ...
        {/* Header */}
        <header className="log-sheet-header" style={{ padding: '18px 20px 16px', borderBottom: '1px solid var(--glass-edge)', display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 16, position: 'relative', zIndex: 1 }}>
        ...
        {/* Footer / save */}
        {draftItems.length > 0 && (
          <div className="log-sheet-footer" style={{ padding: '16px 20px', borderTop: '1px solid var(--glass-edge)', background: 'linear-gradient(180deg, rgba(8,13,26,0.98), rgba(5,8,17,0.98))', display: 'flex', flexDirection: 'column', gap: 12, position: 'relative', zIndex: 1 }}>
